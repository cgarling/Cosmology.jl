...
function setup_growth(c::AbstractCosmology,a1::Real=1e-5,a2::Real=1.0) # Union{FlatWCDM,OpenWCDM,ClosedWCDM}
    ...
    interp3 = Spline1D(growth_f./maximum(growth_f),z_arr; k=4, bc="nearest", s=0.0) #invert the growth function
...
# function setup_growth(c::Union{FlatLCDM,OpenLCDM,ClosedLCDM},a1::Real=1e-5,a2::Real=1.0)
#     z_min=1/a_min - 1
#     z_max=1/a_max - 1
#     function Ez_D(z)
# 	ai = (1.0 + z)
#         E = sqrt( (c.Ω_m + c.Ω_n) * ai^3 + c.Ω_Λ * de_density_scale(c,z) )
#     end
